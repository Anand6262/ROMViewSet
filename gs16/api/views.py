...
#Through ReadOnlyModelViewSet class we can perform list() and retrieve() operations
#list() -> To GET data
#retrieve -> To GET specific data
class StudentROMVSet(viewsets.ReadOnlyModelViewSet):
...
# class StudentModelViewSet(viewsets.ModelViewSet): #To perform all CRUD operations
#     queryset=Student.objects.all()
#     serializer_class=StudentSerializer
